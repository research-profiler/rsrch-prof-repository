...
{
    public partial class ResearcherProfilerRepository_DEVContext : DbContext
    {
        public ResearcherProfilerRepository_DEVContext()
        {
        }

        public ResearcherProfilerRepository_DEVContext(DbContextOptions<ResearcherProfilerRepository_DEVContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseNpgsql("Host=localhost;Database=ResearcherProfilerRepository_DEV;Username=postgres;Password=AwesomePwd");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Aggregation>(entity =>
            {
                ...
                entity.Property(e => e.CsvColumn)
                    .HasColumnName("csv_column")
